...
public class TaxiRightBlue extends SubsystemBase {
  SwerveSubsystem swerve;

  /** Creates a new Autos. */
  public TaxiRightBlue(SwerveSubsystem swerveSubsystem) {
  ...
  public Command taxiRightBlue() {
    return AutoBuilder.buildAuto("taxiRightBlue");
  }
