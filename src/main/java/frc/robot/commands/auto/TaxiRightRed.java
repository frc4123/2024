...
public class TaxiRightRed extends SubsystemBase {
  SwerveSubsystem swerve;

  /** Creates a new Autos. */
  public TaxiRightRed(SwerveSubsystem swerveSubsystem) {
  ...
  public Command taxiRightRed() {
    return AutoBuilder.buildAuto("taxiRightRed");
  }
