...
public class ThreeNoteLong extends SubsystemBase {
  SwerveSubsystem swerve;

  /** Creates a new Autos. */
  public ThreeNoteLong(SwerveSubsystem swerveSubsystem) {
  ...
  public Command threeNoteLong() {
    return AutoBuilder.buildAuto("threeNoteLong");
  }
