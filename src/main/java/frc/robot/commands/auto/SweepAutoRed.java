...
public class SweepAutoRed extends SubsystemBase {
  SwerveSubsystem swerve;

  /** Creates a new Autos. */
  public SweepAutoRed(SwerveSubsystem swerveSubsystem) {
  ...
  public Command sweepAutoRed() {
    return AutoBuilder.buildAuto("sweepAutoRed");
  }
