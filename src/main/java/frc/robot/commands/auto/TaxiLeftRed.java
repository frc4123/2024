...
public class TaxiLeftRed extends SubsystemBase {
  SwerveSubsystem swerve;

  /** Creates a new Autos. */
  public TaxiLeftRed(SwerveSubsystem swerveSubsystem) {
  ...
  public Command taxiLeftRed() {
    return AutoBuilder.buildAuto("taxiLeftRed");
  }
